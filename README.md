...
En este documento se detalla el modo de utilización tanto del frontal en REACT. Para documentación detallada de la API puedes utilizar el repo siguiente https://github.com/IsmaelB83/keepcoding-backend-node
...
En el fichero ubicado en /src/config.js puedes configurar varios parámetros importantes para la aplicación, como son la url de la API que sirve nodepop, la url base donde sirve esa API las imagenes, 
